...
class NeZhaModel(NeZhaPreTrainedModel):
    ...
    the self-attention modules, following the architecture described in `Attention is all you need`_ by Ashish Vaswani,
...
@add_start_docstrings(
    ...
    modules on top of the hidden-states output to compute `span start logits` and `span end logits`). """,
    BERT_START_DOCSTRING,
)
