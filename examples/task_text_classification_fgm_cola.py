...
def main():
    ...
    parser.add_argument('--adv_name', type=str, default='word_embeddings', help="name for adversarial layer.")
    parser.add_argument('--adv_epsilon', type=float, default=1.0, help='Epsilon for adversarial.')
