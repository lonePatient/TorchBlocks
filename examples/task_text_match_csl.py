...
class CslDataset(DatasetBaseBuilder):
...
def load_data(opts, file_name, data_type, tokenizer, max_sequence_length):
    process_piplines = [ProcessEncodeText(CslDataset.label2id(),
                                          tokenizer,
                                          tokenizer_params={
                                              "padding": "max_length",
    ...
    return CslDataset(opts, file_name, data_type=data_type, process_piplines=process_piplines)
