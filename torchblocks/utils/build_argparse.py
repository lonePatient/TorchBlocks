...
def build_argparse(description=None):
    ...
    parser.add_argument("--gpu", type=str, default='0',
                        help='multi-gpu:"0,1,.." or single-gpu:"0" or cpu:""')
    ...
    parser.add_argument("--correct_bias", default=True, action="store_true",
                        help="Whether to correct bias.")
    ...
    parser.add_argument('--num_workers', default=0, type=int,
                        help='how many subprocesses to use, ``0`` means that the data will be loaded in the main process.')
