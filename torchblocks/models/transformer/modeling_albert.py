...
class AlbertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        # project transform
        words_embeddings = self.word_embeddings_2(inputs_embeds)
...
class AlbertModel(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertModel.from_pretrained('bert-base_cn-uncased')
...
class AlbertForPreTraining(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertForPreTraining.from_pretrained('bert-base_cn-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute")).unsqueeze(0)  # Batch size 1
        outputs = model(input_ids)
...
class AlbertForMaskedLM(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertForMaskedLM.from_pretrained('bert-base_cn-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute")).unsqueeze(0)  # Batch size 1
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None,
                inputs_embeds=None,masked_lm_labels=None):
        outputs = self.bert(input_ids,
                            attention_mask=attention_mask,
                            token_type_ids=token_type_ids,
                            position_ids=position_ids,
...
class AlbertForNextSentencePrediction(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertForNextSentencePrediction.from_pretrained('bert-base_cn-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute")).unsqueeze(0)  # Batch size 1
        outputs = model(input_ids)
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None,
                inputs_embeds=None,next_sentence_label=None):
        outputs = self.bert(input_ids,
                            attention_mask=attention_mask,
                            token_type_ids=token_type_ids,
                            position_ids=position_ids,
...
class AlbertForSequenceClassification(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertForSequenceClassification.from_pretrained('bert-base_cn-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute")).unsqueeze(0)  # Batch size 1
...
class AlbertForMultipleChoice(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertForMultipleChoice.from_pretrained('bert-base_cn-uncased')
...
class AlbertForTokenClassification(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertForTokenClassification.from_pretrained('bert-base_cn-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute")).unsqueeze(0)  # Batch size 1
...
class AlbertForQuestionAnswering(AlbertPreTrainedModel):
    ...
    Examples::
        tokenizer = BertTokenizer.from_pretrained('bert-base_cn-uncased')
        model = BertForQuestionAnswering.from_pretrained('bert-base_cn-uncased')
        input_ids = torch.tensor(tokenizer.encode("Hello, my dog is cute")).unsqueeze(0)  # Batch size 1
