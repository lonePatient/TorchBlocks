...
from transformers.modeling_bert import BertIntermediate,BertSelfOutput,BertOutput,BertPooler
...
class NeZhaEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        embeddings = inputs_embeds + token_type_embeddings  # position_embeddings + token_type_embeddings
...
BERT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        head_mask (:obj:`torch.FloatTensor` of shape :obj:`(num_heads,)` or :obj:`(num_layers, num_heads)`, `optional`, defaults to :obj:`None`):
            Mask to nullify selected heads of the self-attention layers.
            Mask values selected in ``[0, 1]``:
...
class NeZhaModel(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-en-uncased')
        model = BertModel.from_pretrained('bert-base-en-uncased')
...
class NeZhaForPreTraining(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-en-uncased')
        model = BertForPreTraining.from_pretrained('bert-base-en-uncased')
...
class NeZhaForMaskedLM(BertPreTrainedModel):
    ...
    Returns:
        ...
        Examples::
            ...
            tokenizer = BertTokenizer.from_pretrained('bert-base-en-uncased')
            model = BertForMaskedLM.from_pretrained('bert-base-en-uncased')
...
class NeZhaForNextSentencePrediction(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-en-uncased')
        model = BertForNextSentencePrediction.from_pretrained('bert-base-en-uncased')
...
class NeZhaForSequenceClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-en-uncased')
        model = BertForSequenceClassification.from_pretrained('bert-base-en-uncased')
...
class NeZhaForMultipleChoice(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-en-uncased')
        model = BertForMultipleChoice.from_pretrained('bert-base-en-uncased')
...
class NeZhaForTokenClassification(BertPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = BertTokenizer.from_pretrained('bert-base-en-uncased')
        model = BertForTokenClassification.from_pretrained('bert-base-en-uncased')
